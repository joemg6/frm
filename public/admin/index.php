...
<?php 
    ...
    if($err == 1){
    	...
    	echo "<script>case_alert(\"error\", \"../admin/\", \"1000\");</script>";
    } 
?>
...
<div id="wrapper">
	<form name="login-form" class="login-form" action="/" method="post">
		...
		<div class="content">
			<p style="color:#3E5367;font-weight:bold;text-align: center;margin-bottom: 10px;">Administrador</p>
			<input name="level_profile" type="hidden" value="0"  >
			<input name="typeProfile" type="hidden" value="admin"  >
